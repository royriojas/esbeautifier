...
- **Build Scripts Changes**
  - upgrade to latest esformatter-jsx - [a23ae4d]( https://github.com/royriojas/esbeautifier/commit/a23ae4d ), [Roy Riojas](https://github.com/Roy Riojas), 29/11/2016 21:35:45

    
## v10.1.1
- **Build Scripts Changes**
  - Update esformatter-jsx dep - [7cc6d7b]( https://github.com/royriojas/esbeautifier/commit/7cc6d7b ), [Roy Riojas](https://github.com/Roy Riojas), 12/06/2016 03:28:48
...
- **Features**
  - Update to latest esformatter and esformatter-jsx - [9c943e3]( https://github.com/royriojas/esbeautifier/commit/9c943e3 ), [Roy Riojas](https://github.com/Roy Riojas), 27/03/2016 03:12:12
    ...
    **BREAKING CHANGE**
    ...
    The `esformatter-collapse-objects` plugin was removed due to complexity
    to obtain the desired results
    
## v8.0.6
- **Bug Fixes**
  - properly format async object methods - [7705a70]( https://github.com/royriojas/esbeautifier/commit/7705a70 ), [Roy Riojas](https://github.com/Roy Riojas), 13/02/2016 22:51:26
...
## v8.0.2
- **Build Scripts Changes**
  - Use the latest esformatter-jsx for the fix for async/await - [a3fb519]( https://github.com/royriojas/esbeautifier/commit/a3fb519 ), [Roy Riojas](https://github.com/Roy Riojas), 22/11/2015 17:36:36

    
## v8.0.1
- **Bug Fixes**
  - Properly format code with async token on function expressions - [86875cd]( https://github.com/royriojas/esbeautifier/commit/86875cd ), [Roy Riojas](https://github.com/Roy Riojas), 22/11/2015 17:13:23

    
## v8.0.0
- **Build Scripts Changes**
  - Update to latest version of esformatter-jsx to properly handle the async tokens - [68445ab]( https://github.com/royriojas/esbeautifier/commit/68445ab ), [Roy Riojas](https://github.com/Roy Riojas), 22/11/2015 16:36:13

    
## v7.0.0
- **Build Scripts Changes**
  - update deps to next major version - [969987e]( https://github.com/royriojas/esbeautifier/commit/969987e ), [royriojas](https://github.com/royriojas), 17/11/2015 02:51:02

    
## v6.1.9
- **Build Scripts Changes**
  - Update to latest esformatter-jsx - [ab2ea59]( https://github.com/royriojas/esbeautifier/commit/ab2ea59 ), [royriojas](https://github.com/royriojas), 13/11/2015 06:45:30
