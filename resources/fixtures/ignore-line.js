...
var fromArgs = require( 'browserify/bin/args' );
  ...
  function normalizeCache( removeDeletedOnly ) {
    ...
    if ( neverCache ) {
      ...
      for (var i = 0; i < neverCache.length; i++) {// esfmt-ignore-line
      if ( file.match( neverCache[ 0 ] ) ) {// esfmt-ignore-line
        delete browserifyOpts.cache;// esfmt-ignore-line
        break;// esfmt-ignore-line
        }// esfmt-ignore-line
      }// esfmt-ignore-line
